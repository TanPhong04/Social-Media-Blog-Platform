...
The public REST contract is documented in `docs/openapi/social-blog-api.yaml`, with error, pagination, and compatibility conventions in `docs/api-conventions.md`. Backend deployment guidance is in `docs/deployment.md`; operations notes and incident runbooks are in `docs/operations.md`.
