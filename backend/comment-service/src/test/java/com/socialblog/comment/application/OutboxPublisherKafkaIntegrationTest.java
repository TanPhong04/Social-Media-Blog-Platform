...
class OutboxPublisherKafkaIntegrationTest {
    ...
    void publishesPendingOutboxEventToKafkaAndMarksItPublished() throws Exception {
        String topic = "comments.events.test-" + UUID.randomUUID();
        createTopic(topic);
    ...
    private OutboxEvent event() {
        ...
        return new OutboxEvent(id, id, "CommentCreated", "{\"eventType\":\"CommentCreated\"}", Instant.now());
    }
}
